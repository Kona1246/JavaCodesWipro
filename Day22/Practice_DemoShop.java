...
public class Practice_DemoShop {
    ...
    public void testJewelrySectionAndAddToCart() {
        ...
        for (int i = 0; i < productLinks.size(); i++) {
            ...
            productLinks = driver.findElements(By.cssSelector(".product-title a"));
            ...
            List<WebElement> lengthField = driver.findElements(By.id("product_attribute_71"));
            if (!lengthField.isEmpty()) {
                lengthField.get(0).clear();
                lengthField.get(0).sendKeys("20"); 
            }
