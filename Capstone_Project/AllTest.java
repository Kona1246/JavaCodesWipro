...
public class AllTest {
	 ...
	 WebDriver driver;
	    ...
	    public void userCanRegisterSuccessfully() throws IOException {
	        ...
	        // Excel file path
	        String excelPath = "C:\\Users\\sayan\\Downloads\\capstone.xlsx";
	        ...
	        try {
	            WebElement genderMale = driver.findElement(By.id("gender-female"));
	    ...
	    @Test(priority = 8)
	    public void Shopping_cart_Quantity() {
	    ...
	    @Test(priority = 13)
	    public void books() {
	        driver.findElement(By.xpath("ul[@class='top-menu mobile']//a[normalize-space()='Books']")).click();
	    }
